        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SerialNumberOrImei = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Barcode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Sku = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PurchasePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SellingPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsernameSnapshot = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImeiOrSerial = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    DeviceColor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    DeviceCondition = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ProblemDescription = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    ReceivedAccessories = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    PhotoPathsJson = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RepairOrders_Users_TechnicianUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RepairParts_RepairOrders_RepairOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RepairStatusHistories_Users_ChangedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ImeiOrSerialSnapshot = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairOrders_RepairCode",
                table: "RepairOrders",
                column: "RepairCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairParts_RepairOrderId",
                table: "RepairParts",
                column: "RepairOrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairStatusHistories_ChangedByUserId",
                table: "RepairStatusHistories",
                column: "ChangedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RepairStatusHistories_RepairOrderId",
                table: "RepairStatusHistories",
                column: "RepairOrderId");
